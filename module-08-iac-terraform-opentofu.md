...
- [Advanced HCL Patterns](#advanced-hcl-patterns)
- [Terraform Testing](#terraform-testing)
- [Atlantis: GitOps for Terraform](#atlantis-gitops-for-terraform)
- [Terragrunt Deep Dive](#terragrunt-deep-dive)
- [OpenTofu-Specific Features](#opentofu-specific-features)
- [Infracost: Cost Estimation in CI](#infracost-cost-estimation-in-ci)
- [Drift Detection](#drift-detection)
- [Secrets Management in Terraform](#secrets-management-in-terraform)
- [Common Mistakes & Pitfalls](#common-mistakes--pitfalls)
- [Interview Prep](#interview-prep)
- [A Day in the Life: Infrastructure Engineer at a SaaS Company](#a-day-in-the-life-infrastructure-engineer-at-a-saas-company)
- [Module Design Patterns](#module-design-patterns)
- [Large-Scale IaC Organisation](#large-scale-iac-organisation)
- [Cross-Account and Multi-Region Patterns](#cross-account-and-multi-region-patterns)
- [Terraform War Stories](#terraform-war-stories)
- [Terraform Performance Optimisation](#terraform-performance-optimisation)
- [Static Analysis: `tflint` and `checkov`](#static-analysis-tflint-and-checkov)
- [Terraform Quick Reference](#terraform-quick-reference)
- [Provisioners: When and How to Use Them](#provisioners-when-and-how-to-use-them)
- [Terraform with Kubernetes](#terraform-with-kubernetes)
- [Packer: Building AMIs with Terraform Workflows](#packer-building-amis-with-terraform-workflows)
- [Workspaces vs Separate State Files](#workspaces-vs-separate-state-files)
- [Continuous Delivery for Infrastructure](#continuous-delivery-for-infrastructure)
- [Advanced Provider Patterns](#advanced-provider-patterns)
- [Hands-On Lab: Three-Tier Infrastructure with Terraform](#hands-on-lab-three-tier-infrastructure-with-terraform)
- [IaC Maturity Model](#iac-maturity-model)
- [Renovate Bot for Terraform Dependency Management](#renovate-bot-for-terraform-dependency-management)
- [Terraform Cloud and HCP Terraform](#terraform-cloud-and-hcp-terraform)
- [IaC for Non-AWS Providers](#iac-for-non-aws-providers)
- [Debugging Terraform](#debugging-terraform)
- [Terraform Certification Prep](#terraform-certification-prep)
- [Built-In Functions Reference](#built-in-functions-reference)
- [Terraform and GitOps: The Full Picture](#terraform-and-gitops-the-full-picture)
- [Handling Terraform Upgrades](#handling-terraform-upgrades)
- [Environment Promotion with Terraform](#environment-promotion-with-terraform)
- [IaC Security: Supply Chain and Integrity](#iac-security-supply-chain-and-integrity)
- [Terraform Data Sources: Patterns and Anti-Patterns](#terraform-data-sources-patterns-and-anti-patterns)
- [Real-World Module Examples](#real-world-module-examples)
- [Terraform and Service Mesh: Managing Istio with Terraform](#terraform-and-service-mesh-managing-istio-with-terraform)
